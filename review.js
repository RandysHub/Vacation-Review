...
console.log('Randy ' + 'Perez')

// Create a string and make it return true using startsWith()

let moon = 'moon'
console.log(moon.startsWith('mo'))

// Now use any variable with endsWith() and return false

console.log(moon.endsWith('cat'))
...
// substring()
console.log(angry.substring(11, 16))
...
console.log(aslDays.substring(14, 22))
...
perscholas.forEach(e => console.log(e))
...
// concat() joins to strings
// splice() take a part of an array and create a new one
// slice() takes a part of an array but doesn't create a new one
// sort() sorts through an array. By default it's alphabetical but you can use a call backfunction.
// includes() checks if the argument is included anywhere within the string. Returns true or false
// indexOf() tells you the index the argument starts at.
// length tells you how many elements are in the array
// These are all off the top of my head. Google and double check later
...
fruits.push('strawberry', 'kiwi', 'grape')
console.log(fruits)
// Remove apple
fruits.shift()
console.log(fruits)
...
let exoticFruits = ['mangosteen', 'kiwano', 'chikoo']
let allFruit = fruits.concat(exoticFruits)
console.log(allFruit)
// Print the last two exotic fruits without altering the newly concatenated array.
console.log(allFruit[allFruit.length - 1], allFruit[allFruit.length - 2])
...
console.log(RafaelNoBadWords.split(' ').filter(word => word !== 'badword'))
...
const sum = numbersToAddUp.reduce((prevNum, CurrNum) => prevNum + CurrNum)
console.log(sum)
// ===== SPREAD OPERATOR ===== 

// Create a variable and assign a value of a copied array using the spread operator

const strawHats = ['Luffy', 'Sanji', 'Zoro', 'Nami']
const mugiwaras = [...strawHats]
console.log(mugiwaras)
// Create two arrays with any elements and connect both of them using the spread operator. Save the connected arrays into a new variable.
const grandLineStrawHats = ['Chopper', 'Franky', 'Brook', 'Jinbe', 'Yamato']
let allStrawHats = [...strawHats, ...grandLineStrawHats]
console.log(allStrawHats)
// Using the variable with the newly connected arrays, use spread operator to add something at the end.
const carrot = ['Carrot']
allStrawHats = [...allStrawHats, ...carrot]
console.log(allStrawHats)
// Using the variable with the newly connected arrays, use spread operator to add something at the beginning.
allStrawHats = ['Vivi', ...allStrawHats, ...carrot]
console.log(allStrawHats)
...
if (teo.person) {
  if (teo.sex === 'male') {
    if (teo.hungry === true) {
      console.log(`Let's go buy some tacos!`)
...
let sayGreeting = () => console.log(`Hello, ma'amsir!`)
sayGreeting();
...
let print = (string) => console.log('This is my ' + string);
print('turtle');
